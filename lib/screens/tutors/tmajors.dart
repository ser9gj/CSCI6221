...
import 'package:tutorly/screens/tutors/tcmpe.dart';

class TMajors extends StatefulWidget {
  @override
  _TMajorsState createState() => _TMajorsState();
}

class _TMajorsState extends State<TMajors> {
  @override
                ...
                ListTile(
                  ...
                  onTap: (){
                    ...
                    new MaterialPageRoute(
                        builder: (BuildContext context) => new CMPE()));
